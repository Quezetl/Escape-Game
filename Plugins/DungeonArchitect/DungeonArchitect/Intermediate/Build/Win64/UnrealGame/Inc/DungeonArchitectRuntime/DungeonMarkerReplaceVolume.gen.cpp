...
template<> DUNGEONARCHITECTRUNTIME_API UScriptStruct* StaticStruct<FMarkerReplaceEntry>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Core_Volumes_DungeonMarkerReplaceVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ADungeonMarkerReplaceVolume, ADungeonMarkerReplaceVolume::StaticClass, TEXT("ADungeonMarkerReplaceVolume"), &Z_Registration_Info_UClass_ADungeonMarkerReplaceVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADungeonMarkerReplaceVolume), 2543214052U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Core_Volumes_DungeonMarkerReplaceVolume_h_3696857696(TEXT("/Script/DungeonArchitectRuntime"),
