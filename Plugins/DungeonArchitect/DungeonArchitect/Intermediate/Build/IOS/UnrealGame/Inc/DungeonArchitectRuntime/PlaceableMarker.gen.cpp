...
template<> DUNGEONARCHITECTRUNTIME_API UScriptStruct* StaticStruct<FPlaceableMarkerAssetSpriteSettings>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_ThemeEngine_Markers_PlaceableMarker_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_APlaceableMarkerActor, APlaceableMarkerActor::StaticClass, TEXT("APlaceableMarkerActor"), &Z_Registration_Info_UClass_APlaceableMarkerActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APlaceableMarkerActor), 2872908086U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_DungeonArchitect_Source_DungeonArchitectRuntime_Public_Frameworks_ThemeEngine_Markers_PlaceableMarker_h_2934391104(TEXT("/Script/DungeonArchitectRuntime"),
